...
<script type="text/javascript">
    ...
    function userNewsFeedCallback() {
        $("#statusUpdateSubmit").click(function() {
            ...
            submitStatusUpdate('<c:url value="${url.basePreview}"/>', '${currentNode.path}', '${user.path}', updateText, '${ps}', '${currentNode.properties['numberOfNewsFeedPerPage'].string}');
            return false;
        });

        loadActivities('<c:url value="${url.basePreview}"/>', '${currentNode.path}', '${user.path}', '${ps}', '${currentNode.properties['numberOfNewsFeedPerPage'].string}');
